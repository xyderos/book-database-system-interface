...
--USE CASCADE TO DROP A TABLE AND ALL ITS REFERENCES TO OTHER TABLES
DROP TABLE IF EXISTS PUBLISHERS CASCADE;

CREATE TABLE PUBLISHERS (
	PUBLISHER_ID INTEGER NOT NULL PRIMARY KEY,
	NAMM VARCHAR(255)NOT NULL,
	ADR VARCHAR(255)
);
...
CREATE TABLE AUTHORS (
	...
	EFTERNAMM VARCHAR(255)NOT NULL,
	FORENAMM VARCHAR(255)NOT NULL,
);
...
CREATE TABLE CUSTOMERS (
	ID INTEGER NOT NULL PRIMARY KEY,
	EFTERNAMM VARCHAR(255),
	FORENAMM VARCHAR(255),
);
...
CREATE TABLE BOOKS (
	...
	S_ID INTEGER REFERENCES SUBJECTS(SUB_ID),
);

DROP TABLE IF EXISTS EDITIONS CASCADE;
CREATE TABLE EDITIONS (
	ISBN VARCHAR(255) NOT NULL PRIMARY KEY,
	ID INTEGER NOT NULL REFERENCES BOOKS(ID),
	EDITION INTEGER NOT NULL,
	P_ID INTEGER NOT NULL,
	DT DATE,
	CONSTRAINT INTEGRITY CHECK (((BOOKS(ID) NOTNULL) AND (EDITION NOTNULL))),
);
...
CREATE TABLE SHIPMENTS (
	ID SERIAL,
	C_ID INTEGER REFERENCES CUSTOMERS(ID) PRIMARY KEY,
	ISBN VARCHAR(255) REFERENCES EDITIONS(ISBN),
